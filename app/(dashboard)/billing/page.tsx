  ...
  const plans = [
    {
      name: 'Plan Inicial',
      price: '$9/mes',
      desc: 'Ideal para veterinarios independientes y clínicas locales.',
      features: [
        '1 Cuenta de Profesional',
        'Hasta 500 Fichas de Pacientes',
        'Calendario de Citas',
        'Historias Clínicas Básicas',
        'Recordatorios por Email',
        'Centro de Ayuda Autoservicio'
      ],
      key: 'starter'
    },
    {
      ...
      price: '$19/mes',
      desc: 'Nuestro plan más popular para clínicas con alta actividad.',
      features: [
        ...
        'Validación de Reservas por SMS/Email',
        'Analíticas Completas del Consultorio',
    ...
    <div className="space-y-6 md:space-y-8 animate-fade-in font-sans">
      ...
      <div className="mb-2 rounded-lg bg-emerald-50 border border-emerald-200/80 p-3 text-xs text-emerald-800 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <span>Renderizando interfaces de facturación e integración con Stripe.</span>
        </div>
      ...
      {/* Page Header */}
      <div>
        <h2 className="text-2xl font-bold tracking-tight text-neutral-900 md:text-3xl">Facturación y Suscripciones</h2>
        <p className="text-sm text-neutral-500 mt-1">Administre las licencias de la clínica, actualice las credenciales de pago y revise las transacciones clínicas.</p>
      </div>
        ...
        <div className="md:col-span-1 space-y-6">
          <Card className="border border-neutral-100 bg-white shadow-xs">
            <CardHeader className="pb-4 border-b border-neutral-50">
              <CardTitle className="text-sm font-bold text-neutral-900">Plan Actual</CardTitle>
              <CardDescription className="text-xs text-neutral-500">El alcance de la suscripción de su veterinaria.</CardDescription>
            </CardHeader>
            <CardContent className="p-5 space-y-4">
              <div className="flex items-center justify-between">
                <span className="text-xs text-neutral-400 font-semibold uppercase tracking-wider">Plan Activo</span>
                <span className="text-xs font-bold text-emerald-700 bg-emerald-50 border border-emerald-100 px-2 py-0.5 rounded-full">
                  {statusInfo.planName === 'Starter Plan' ? 'Plan Inicial' : statusInfo.planName === 'Professional Plan' ? 'Plan Profesional' : statusInfo.planName}
                </span>
              </div>

              <div className="flex items-center justify-between">
                <span className="text-xs text-neutral-400 font-semibold uppercase tracking-wider">Estado de Prueba</span>
                <span className={`text-xs font-bold px-2 py-0.5 rounded-full ${statusInfo.isExpired ? 'bg-rose-50 text-rose-700 border border-rose-100' : 'bg-neutral-100 text-neutral-800'}`}>
                  {statusInfo.isExpired ? 'Expirado' : `${statusInfo.remainingDays} días restantes`}
                </span>
              </div>
              ...
              {statusInfo.isTrial && (
                <div className="rounded-lg bg-neutral-50/50 border border-neutral-200/40 p-3.5 space-y-2">
                  ...
                  <p className="text-[10px] text-neutral-400 leading-normal">
                    Actualmente está utilizando VetControl en una prueba gratuita de 14 días. Actualice para conservar todos los registros de pacientes, calendarios y alertas.
                  </p>
                </div>
              )}
            </CardContent>
          ...
          <Card className="border border-neutral-100 bg-white shadow-xs">
            <CardHeader className="pb-3 border-b border-neutral-50 flex flex-row items-center gap-2 space-y-0">
              ...
              <div>
                <CardTitle className="text-sm font-bold text-neutral-900">Historial de Pagos</CardTitle>
                <CardDescription className="text-xs text-neutral-500">Comprobantes recientes.</CardDescription>
              </div>
            </CardHeader>
            <CardContent className="p-5 text-center text-xs text-neutral-400 py-8 font-medium">
              Aún no se han generado facturas de suscripción.
            </CardContent>
          </Card>
        </div>
        ...
        <div className="md:col-span-2 space-y-6">
          ...
          <div className="bg-emerald-50 border border-emerald-100 rounded-xl p-5 flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="space-y-1">
              <h4 className="text-xs font-bold text-emerald-900">¿Requisitos especiales para su hospital?</h4>
              <p className="text-[11px] text-emerald-700/80 leading-normal max-w-md">
                Si administra varias sucursales locales o necesita configuraciones e integraciones a medida, contáctenos.
              </p>
            </div>
            <a 
