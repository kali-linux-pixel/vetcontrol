...
export default function SalesPage() {
  ...
  const [invoices, setInvoices] = useState<Invoice[]>([
    { id: 'inv-1024', clientName: 'Sarah Connor', petName: 'Max', amount: 125.00, date: '2026-05-26', status: 'Paid', itemDescription: 'Rabies Booster + Consultation' },
    { id: 'inv-1025', clientName: 'Elena Gilbert', petName: 'Milo', amount: 450.00, date: '2026-05-26', status: 'Pending', itemDescription: 'Surgery (Neuter) & Post-Op Meds' },
    { id: 'inv-1026', clientName: 'Bruce Wayne', petName: 'Ace', amount: 85.00, date: '2026-05-26', status: 'Paid', itemDescription: 'Ear Infection Check-up' },
    { id: 'inv-1027', clientName: 'Elena Gilbert', petName: 'Gilbert', amount: 62.50, date: '2026-05-25', status: 'Paid', itemDescription: 'Vaccination RHDV2' },
    { id: 'inv-1028', clientName: 'Arya Stark', petName: 'Nymeria', amount: 320.00, date: '2026-05-24', status: 'Paid', itemDescription: 'Dental Scaling and Polish' },
    { id: 'inv-1029', clientName: 'Peter Parker', petName: 'Webby', amount: 45.00, date: '2026-05-24', status: 'Paid', itemDescription: 'Consultation Molting' },
    { id: 'inv-1030', clientName: 'Sarah Connor', petName: 'Luna', amount: 110.00, date: '2026-05-23', status: 'Refunded', itemDescription: 'Specialty Consultation Fees' },
  ]);
  ...
  // Stats calculation
  const totalBilling = invoices.filter(i => i.status === 'Paid').reduce((acc, curr) => acc + curr.amount, 0);
  const pendingBilling = invoices.filter(i => i.status === 'Pending').reduce((acc, curr) => acc + curr.amount, 0);
  const averageTicket = invoices.length > 0 ? (invoices.reduce((acc, curr) => acc + curr.amount, 0) / invoices.length) : 0;
